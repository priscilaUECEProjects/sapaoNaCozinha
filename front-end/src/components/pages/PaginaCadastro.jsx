    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-[var(--color-quinacridone-magenta)] bg-[url('./assets/img/fundo-roxo.png')] bg-repeat bg-[size:500px]">
            <div className="text-[#55133b]"> 
                <form className="flex flex-col items-center gap-4 p-4 w-18/18 bg-[#e6e1c5] rounded-2xl shadow-[-10px_-10px_30px_4px,_10px_10px_30px_4px]" onSubmit={handleSubmit}>
                    <h1 className="text-3xl mb-5 font-bold">Cadastro</h1>

                    <label htmlFor="nome-usuario" className="font-bold">Nome</label>
                    <input type="text" id="nome-usuario" name="nome-usuario" className="w-full border-[1px] border-[#55133b] rounded text-md"
                    value={nome} onChange={(e)=> setNome(e.target.value)}/>
                    
                    <label htmlFor="email" className="font-bold">Email</label>
                    <input type="email" id="email" name="email" className="w-full border-[1px] border-[#55133b] rounded text-md" 
                    value={email} onChange={(e)=> setEmail(e.target.value)}/>

                    <label htmlFor="senha" className="font-bold">Senha</label>
                    <input type="password" id="senha" name="senha" className="w-full border-[1px] border-[#55133b] rounded text-md" 
                    value={senha} onChange={(e)=> setSenha(e.target.value)} />

                    <label htmlFor="confirmarSenha" className="font-bold">Confirme a senha</label>
                    <input type="password" id="confirmarSenha" name="confirmarSenha" className="w-full border-[1px] border-[#55133b] rounded text-md" 
